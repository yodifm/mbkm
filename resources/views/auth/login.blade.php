    ...
    <div id="auth">
        ...
        <div class="row h-100" style="background-color:#fff">
                ...
                <div id="auth-left">
                    ...
                    <form action="/login" method="POST">
                        ...
                        <div class="mb-4 form-group position-relative has-icon-left">
                            ...
                            <input type="text" class="form-control form-control-xl" placeholder="Nomor Induk Mahasiswa"
                                name="NIK" style="border-color:#000">
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right" style="position: relative; background: linear-gradient(90deg, #DBEBDF, #DBEBDF); border-top-left-radius: 20px; border-bottom-left-radius: 20px;">
                    <img src="{{ asset('logo.png') }}" alt="Logo" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1;">
                </div>
            </div>
